...
※現在、スマホ端末ではクライアントエラーが発生しており、地図ズーム後の投稿が閲覧できない状況です
※今後、改善予定
...
「World Map SNS」は、世界中の国の魅力や情報などを気軽に投稿・共有できる SNSアプリ<br/>
...
- [x] [検索窓の位置修正](https://github.com/y-u27/world/issues/36)
